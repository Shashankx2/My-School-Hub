                ...
                <div class="row">
                    ...
                    <div class="col-md-43">
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
                            ...
                            <div align = "center" style = "margin-bottom: 15px;background: #94BEDA;">
                                <span class="templatemo-service-item-header">MY TESTS</span>
                            </div>
                            <div>
                                    ...
                                    <?php
                                        ...
                                        if($res = mysqli_query($conn,"select * from tests where (SID = '$_SESSION[sid]') and (FACULTY_ID = '$_SESSION[id]') order by SNO desc limit 10"))
                                        {
                    ...
                    <div class="col-md-44">
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
                            ...
                            <div align="center" style = "margin-bottom: 15px;background: #94BEDA;">
                                <span class="templatemo-service-item-header">UPLOADED TESTS</span>
                            </div>
