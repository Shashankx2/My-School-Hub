                        ...
                        <div class="templatemo-service-item">
                            ...
                            <div>
                                    ...
                                    <?php 
                                        ...
                                        if($res = mysqli_query($conn,"select * from notifications where (SchoolCode = '$_SESSION[schoolcode]') AND (Id like 2%) order by Sno desc"))
                                        {
                        ...
                        <div class="templatemo-service-item" >
                            ...
                            <?php
                                ...
                                {           
                                    ...
                                    $r = mysqli_query($conn,"select * from notice where (SchoolCode = '$_SESSION[schoolcode]') AND (Sno = $sno)");
                                    ...
                                    { 
                                        echo "<div  style = 'background-color: #eeeeee; margin-top:10px;'>";
                                            echo    "<div style = 'padding:1.5%;'>";
                                                ...
                                                echo    "</tr></table>";
                                                echo "<b class=blog_post><font color=black>";
