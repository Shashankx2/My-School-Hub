                ...
                <div  role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#" rel="nofollow" style = "padding:0px;"><img src="images/templatemo_logo.png" alt="logo"/></a>
                        </div>
             ...
             <div class="container">
                ...
                <b><div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 15px;">
                                ...
                                <li><a href="#" onclick='navforwardpf()'>Profile</a></li>
            ...
            <div class="container">
                <div class="row">
                                ...
                                echo "  <div class='col-md-41'>
                                        ...
                                        if($res = mysqli_query($conn,"select * from notifications where (SchoolCode = '$_SESSION[schoolcode]') AND (Id like '2%') order by Sno desc limit $notifications"))
                                        {
                                            ...
                                            if($show_notification_button == 1)
                                            {
                                                echo "<p><font size = 4>No New Notifications</font></p>";
                                            }
                                            else if($show_notification_button <= $notifications)
                                            {}
                                            else
                                            {
                                                echo "<br><div class='text-center'><a rel='nofollow' href='homepage.php?count=$notifications' class='templatemo-btn-read-more btn btn-orange'>Older Notifications</a></div>";
                                            }
                                        }
                                    ?>       
                            </div>
                    ...
                    <div class="col-md-42">
                        <div class="templatemo-service-item" >
                            ...
                            <div align = "center" style = "margin-bottom: 20px;">
                                ...
                                <span class="templatemo-service-item-header">ADD NOTICE</span>
                            </div>


                            <div align = "center">
                                <form action="notice.php" method="post" onsubmit = "return checkupdatefun()" enctype="multipart/form-data">
							     ...
							     <textarea required="required" placeholder = "Add Title" class = "font" name = "title" id = "update" style="margin: 0px; width: 371px; height: 30px;"></textarea><br><br>
                                <textarea required="required" placeholder = "Add Content" class = "font" name = "content" id = "update" style="margin: 0px; width: 371px; height: 147px;"></textarea>
                                 <br><br>   
                                 <input type="file" name="notice">
                                    <div class="text-center" style = "margin-top: 10px;">
                                    <button type="submit" class="btn btn-orange pull-center">Add</button>
                                    &nbsp&nbsp<button type="reset" class="btn btn-orange pull-center">Clear</button></div></form>
                            </div>
                            <br>
