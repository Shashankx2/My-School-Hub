...
{ 
 $conn = mysqli_connect("localhost","root","","test");
  ...
  $query = "SELECT * FROM faculty where (ID = '$_SESSION[id]' )";
	  ...
	  $query1 = "SELECT * FROM assignment where (SID = '$_SESSION[sid]') and (Id = '$_SESSION[id]') and (SNO = '$_GET[sno]')";
                ...
                <div class="row">
                    ...
                    <div class="col-md-43">
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
                            ...
                            <div align = "center" style = "margin-bottom: 15px;background: #94BEDA;">
                                <span class="templatemo-service-item-header">My Uploaded Assignments</span>
                            </div>
                            <div>
                                    ...
                                    <?php
                                        ...
                                        if($res = mysqli_query($conn,"select * from assignment where (SID = '$_SESSION[sid]') and (ID = '$_SESSION[id]') order by SNO desc limit 10"))
                                        {
                                            while($row=mysqli_fetch_array($res))
                                            { 
												echo "<div style='font-size:16px;'><a href='editassignment-faculty.php?target=assignment&sno=$row[SNO]' style='color:#333';>edit</a>
													  <a href='delete-faculty.php?target=assignment&sno=$row[SNO]' style='color:#333';>delete</a></div>
												<a href = 'singleassignment-faculty.php?sno=$row[SNO]' style='text-decoration:none;' onmouseover=assignmenticonchange('".$row['SNO']."') onmouseout=assignmenticonchange2('".$row['SNO']."')>
                    ...
                    <div class="col-md-44">
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
                            ...
                            <div align="center" style = "margin-bottom: 15px;background: #94BEDA;">
                                <span class="templatemo-service-item-header">Edit Assignment</span>
                            </div>
						<!--  form ------------------>
							<form action="saveassignment.php?target=update&sno=<?php echo $sno; ?>" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<input type="text" class="form-control" placeholder="Title.." name="atitle" value="<?php echo $title; ?>" />
								</div>
								<div class="form-group">
									<textarea  class="form-control" style="height: 60px;" placeholder="Description..." name="acontent"><?php echo $content; ?></textarea>
								</div>
								<div class="form-group">
