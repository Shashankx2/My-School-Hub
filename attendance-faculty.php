    ...
    <body style="background:#94BEDA;">
        ...
        <div class="templatemo-service">
			...
			if($_REQUEST['status'] == 'success')
				echo "<div class='row' id='statusbox' style='display:block;'>";
			else
				echo "<div class='row' id='statusbox' style='display:none;'>";
			?>
				    <div>
                        <div class="templatemo-service-item" style='background: #ECA1A1;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;margin-left: 14px;margin-right: 14px;margin-top: -30px;margin-bottom: 22px;'>
						<img src="images/cross.png" id="closebutton" height="30" width="30" onclick="disappear()">&nbsp Your attendance has been saved successfully 
						</div>
					</div>
				</div>
                <div class="row">
