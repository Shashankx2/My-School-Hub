                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" >
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 14px;">
								...
								<li class="active"><a href="notice-faculty.php" onclick='navforwardnfaculty()'>NOTICES</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-42">
                        <div class="templatemo-service-item">
							...
							<div id='singlenotice' style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;margin-bottom: 17px;'>
								<div align="center" style = "margin-bottom: 15px;background: #94BEDA;">
									<span class="templatemo-service-item-header">Single - Notice</span>
								</div>
								<div>
                                    ...
                                    <?php
                                        ...
                                        if($res = mysqli_query($conn,"select * from notice where (SID = '$_SESSION[sid]') and (SNO = '$sno')"))
                                        {
                                            ...
                                            { 
												...
												echo "
												<div float = 'left' style='font-size: 15px;margin-bottom:20px;padding:20px;'>
												<table><tr><td>
													Uploaded on: </td><td><font color=#428bca>".$row['DATE']." (".$row['NAME'].") </td></tr><tr><td>
													Title: </td><td><font color=#428bca>".$row['TITLE']."       </td></tr><tr><td>
													Description: </td><td><font color=#428bca>".$row['CONTENT']."</td></tr><tr><td>
													Attachment: </td><td><font color=#428bca>".$link."  </td></tr>
												</table>
												</div>";
                                            }
										}
