                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" >
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 14px;">
                                ...
                                <li class="active"><a href="profile.php" onclick='navforwardp()'>PROFILE</a></li>
                ...
                <?php echo  "
                                <a class='colorbox' href='images/Students/".$_SESSION['photo']."' data-group='gallery-graphic'>
									...
									<div class='navbar-collapse collapse' id='templatemo-nav-bar' >
										<ul class='nav navbar-nav' style='margin-top: 15px; margin-left: 0px; float: left;'>
											<li class='active'><a href='#' onclick='navforwardhome()'>About me</a></li>
											<li><a href='#' onclick='navforwardp()'>Photos</a></li>
											<li><a href='#' onclick='navforwardl()'>Others</a></li>
										</ul>
									</div>
									
                            </li>
                            <li  class='col-md-8' style='border-color: #888;padding: 5px;box-shadow:0px 0px 3px #888;'>
                                ...
                                <p class='blog_text'>
                                    ...
                                    <tr><td><b><font size=3>Class : </b> </td><td><font size=2> ".$_SESSION['cid']." </td></tr>
                    ...
                    <div class="col-md-44">
                        ...
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
							...
							<table align='center' border='1' style='width:100%;border-style:hidden;box-shadow:0px 0px 5px #888;' CELLPADDING='6'>
								...
								<?php
									  $query = "select * from timetable where (SID = '$_SESSION[sid]') AND (CID = '$_SESSION[cid]' )";
											if($r = mysqli_query($conn,$query))
											{
												 while($row=mysqli_fetch_array($r))
												 {
													echo "<tr> 
														...
														<td style='background:#fff;'>".$row['MONDAY']."</td>
														<td style='background:#eee;'>".$row['TUESDAY']."</td>
														<td style='background:#fff;'>".$row['WEDNESDAY']."</td>
														<td style='background:#eee;'>".$row['THURSDAY']."</td>
														<td style='background:#fff;'>".$row['FRIDAY']."</td>
														<td style='background:#eee;'>".$row['SATURDAY']."</td>
													</tr>";
												 }
											}
								?>
