            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-42">
                        ...
                        <div >
                            <?php
                                ...
                                $studentid = $_SESSION['id'];
                                if($r = mysqli_query($conn,"select * from updates where (SID = '$_SESSION[sid]') AND (CID = '$_SESSION[cid]') order by SNO desc limit 10"))
                                {   
                                    while($row=mysqli_fetch_array($r))
                                    {                                    
                    ...
                    <!-- Update division ends -->
                        ...
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;height: 385px;'>
                            <div>
                                <span class="templatemo-service-item-header">Overall Attendance Progress <font size='2'><a href='attendance.php'>view attendance</a></font></span>
                            </div>
