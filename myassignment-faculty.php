...
{ 
 $conn = mysqli_connect("localhost","root","","test");
  ...
  $query = "SELECT * FROM faculty where (ID = '$_SESSION[sid]' )";
                ...
                <div class="row">
                            ...
                            <div>
                                    ...
                                    <?php
                                        ...
                                        if($res = mysqli_query($conn,"select * from assignment where (SID = '$_SESSION[sid]') and (ID = '$_SESSION[id]') order by SNO desc limit 10"))
                                        {
                                            ...
                                            { 
												echo "<div style='font-size:16px;'><a href='editassignment-faculty.php?sno=$row[SNO]' style='color:#333';>edit</a>
                    ...
                    <div class="col-md-44">
                        <div class="templatemo-service-item" style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
                            ...
                            <div align="center" style = "margin-bottom: 15px;background: #94BEDA;">
                                <span class="templatemo-service-item-header">Uploaded Assignments - All</span>
                            </div>
							<a class="btn btn-orange" href="#" role="button">My Uploads</a>
                            <br><br>
                            <div>
