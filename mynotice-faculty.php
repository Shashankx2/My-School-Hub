						...
						<div style='background: #fff;border-radius: 4px;box-shadow: 0px 0px 5px #888;padding: 10px;'>
                            ...
                            <div>
                                    ...
                                    <?php
                                        ...
                                        if($res = mysqli_query($conn,"select * from notice where (SID = '$_SESSION[sid]') and (ID = '$_SESSION[id]')order by SNO desc limit 10"))
                                        {
                                            ...
                                            { 
												...
												<div float = 'left' style='font-size: 18px;margin-bottom:20px'>
													...
													".$row['TITLE']."
													</a><div><a href='editnotice-faculty.php?sno=".$row['SNO']."'>edit</a> | <a href='delete-faculty.php?sno=".$row['SNO']."&target=notice'>delete</a></div></div>";
                                            }
