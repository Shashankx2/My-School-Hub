                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <?php
                                    if($_REQUEST["flag"] == 1)
                                    {
                                        echo "<h1>Your ID or Password is wrong...</h1>";
                                    }
                                    else if($_REQUEST["flag"] == 2)
                                    {
                                        echo "<h1>Your have not registered yet...</h1>";
                                    }
                                    else
                                    {
                                        echo "<h1>Your registration code is invalid...</h1><br><br>";
                                        echo    "<p>Contact your class teacher...</p>";
                                    }
                                ?>
                            </div>
                        </div>
